      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-6 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-800">GözBakım Kliniği</span>
          </div>
          <nav className="hidden md:flex space-x-4">
            <a href="#anasayfa" className="text-gray-600 hover:text-blue-600">Ana Sayfa</a>
            <a href="#hizmetler" className="text-gray-600 hover:text-blue-600">Hizmetler</a>
            <a href="#ekibimiz" className="text-gray-600 hover:text-blue-600">Ekibimiz</a>
      ...
      <main>
        <section id="anasayfa" className="bg-blue-600 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold mb-4">GözBakım Kliniğine Hoş Geldiniz</h1>
            <p className="text-xl mb-8">Daha net bir gelecek için uzman göz bakımı sunuyoruz</p>
            <Button variant="secondary" size="lg">Randevu Al</Button>
          </div>
        </section>
        ...
        <section id="hizmetler" className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {["Kapsamlı Göz Muayenesi", "Katarakt Ameliyatı", "LASIK", "Glokom Tedavisi", "Çocuk Göz Bakımı", "Kontakt Lens Uygulaması"].map((hizmet, index) => (
                <Card key={index}>
                  <CardHeader>
                    <CardTitle>{hizmet}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <CardDescription>En son teknoloji ve tekniklerle üst düzey {hizmet.toLowerCase()} hizmeti sunuyoruz.</CardDescription>
                  </CardContent>
                </Card>
              ))}
            </div>
              ...
              {[
                ...
                <Card key={index}>
                  ...
                  <CardContent>
                    ...
                    <p className="text-center">10 yılı aşkın süredir mükemmel göz bakımı hizmeti sunmaktadır.</p>
                  </CardContent>
                </Card>
              ))}
            </div>
